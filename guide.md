...
Week 1
Topic: JavaScript & Git
Tasks Completed: Install tools, JavaScript exercises, Git commands
Project Completed: Command-Line Task Manager



Week 2
Topic: React.js Basics
Tasks Completed: Set up Create React App, Build component, Style with CSS
Project Completed: Counter Web App



Week 3
Topic: Node.js & Express.js
Tasks Completed: Set up Express server, Create/test endpoints, Error handling
Project Completed: Task Manager API



Week 4
Topic: React.js + APIs
Tasks Completed: Fetch public API, Handle loading/errors, Connect to API
Project Completed: Task Manager Web App



Week 5
Topic: DevOps - Git & CI/CD
Tasks Completed: Git branching/merging, GitHub Actions setup, Docker basics
Project Completed: CI/CD Pipeline for API



Week 6
Topic: React.js Advanced
Tasks Completed: Multi-page app, useContext practice, localStorage usage
Project Completed: Enhanced Task Manager Web App



Week 7
Topic: React Native Basics
Tasks Completed: Set up Expo CLI, Build simple app, Mobile styling
Project Completed: Mobile Task Manager App



Week 8
Topic: Capstone & Testing
Tasks Completed: Write Jest tests, Test React.js UI, Deploy API
Project Completed: Personal Budget Tracker
